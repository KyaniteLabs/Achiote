...
**Repository**: Achiote
**Description**: Culinary reverse engineering system that recreates the sensory triggers of nostalgic dishes using locally available ingredients
...
This is the **Achiote** repository. It is Culinary reverse engineering system that recreates the sensory triggers of nostalgic dishes using locally available ingredients.
